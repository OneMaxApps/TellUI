 ...
 * 
 * <p>Defines parameters that control how components are positioned and sized
 * in linear axis layouts (both vertical and horizontal). Parameters include
...
public abstract class LinearAxisLayoutParams implements LayoutParams {
     ...
     * 
     * <p>Validates all parameters to ensure they are within acceptable ranges.</p>
     * 
     ...
     * 
     * <p>The weight determines how much space the component occupies relative
     * to other components in the layout. The total weight of all components
     * should typically sum to 1.0.</p>
     * 
     ...
     * 
     * <p>Interpretation of alignment values:
     * <ul>

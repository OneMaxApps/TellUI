 ...
 * 
 * <p>This layout extends LinearAxisLayout and provides concrete implementation
 * for linear arrangements. Components are positioned sequentially along either
 * the vertical or horizontal axis based on their weights.</p>
 * 
 * <p>The layout enforces weight constraints to ensure the total weight of all
 * components does not exceed the available space.</p>
 */
public class LinearLayout extends LinearAxisLayout {
     ...
     * weight to exceed available space. Throws an exception if the weight
     * limit would be exceeded.</p>
     * 
     ...
     * 
     * @param isVerticalMode true for vertical layout (components stacked),
     *                       false for horizontal layout (components side by side)
     */

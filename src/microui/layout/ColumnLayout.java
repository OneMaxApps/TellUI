...
/**
 * Layout manager that arranges child components in a vertical column.
 * Extends LinearAxisLayout to provide vertical stacking of components
 * with weight-based sizing and spacing control.
 * <p>
 * The ColumnLayout positions components from top to bottom, allocating
...
public final class ColumnLayout extends LinearAxisLayout {
	 ...
	 * Validates that there is sufficient space for the new component.
	 * 
	...
	/**
	 * Validates that the provided LayoutParams are of the correct type for ColumnLayout.
	 * 
	 * @param layoutParams the layout parameters to validate
	 * @throws IllegalArgumentException if layoutParams is not an instance of ColumnLayoutParams
	 */
	@Override

 ...
 * LinearLayout. Provides convenient constructors for common use cases.</p>
 */
public class LinearLayoutParams extends LinearAxisLayoutParams {
     ...
     * 
     * <p>Uses the same alignment value for both horizontal and vertical axes.</p>
     * 
     * @param weight the weight of the component (0.0 to 1.0)
     * @param align alignment value used for both axes (-1 for left/top, 0 for center, 1 for right/bottom)
     * 
     * @throws IllegalArgumentException if any parameter is outside its valid range
     */
     ...
     * 
     * <p>Uses center alignment (0) for both horizontal and vertical axes by default.</p>
     * 
     * @param weight the weight of the component (0.0 to 1.0)
     * 
     ...
     * 
     * @return the horizontal alignment value (-1 for left, 0 for center, 1 for right)
     */
    @Override

 ...
 * 
 * <p>A specialized linear layout that always arranges components in a horizontal row.
 * Components are positioned side by side from left to right, with widths
 * proportional to their weights.</p>
 * 
 * <p>This layout enforces weight constraints to ensure the total weight of all
 * components does not exceed the available horizontal space.</p>
 */
public final class RowLayout extends LinearAxisLayout {
     ...
     * 
     * <p>Validates that adding the new component does not cause the total
     * weight to exceed available horizontal space. Throws an exception if
     * the weight limit would be exceeded.</p>
     * 
     * @param contentViewEntry the entry being added to the container
     * 
     * @throws IllegalStateException if adding the entry would exceed the weight limit
     */
    @Override
     ...
     * 
     * <p>Initializes the layout in horizontal mode by default.</p>
     */
    public RowLayout() {
        super();
     ...
     * @throws IllegalArgumentException if the parameters are not an instance of RowLayoutParams
     */
    @Override

...
public final class TextEditorModel {
	...
	/**
	 * Constructs a TextEditorModel with empty text content. Initializes the
	 * underlying controller, cursor, selection, and text fragment components.
	 */
	...
	/**
	 * Removes the character at the current cursor position. Does nothing if the
	 * text is blank.
	 */
	...
	/**
	 * Merges the current line with the next line. The cursor row must not be the
	 * last line.
	 */
	 ...
	 *
	 * @param startColumn the start column to set (will be constrained to valid
	 *                    range)
	 */
	 ...
	 *
	 * @return true if selection spans multiple lines, false for single-line
	 *         selection
	 */
	...
	/**
	 * Removes the currently selected text. If no text is selected, does nothing.
	 * After removal, the cursor is positioned at the start of the removed
	 * selection.
	 */

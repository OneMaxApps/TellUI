...
public abstract class RangeControl extends Component implements Scrollable {
    ...
    /**
     * Constructs a RangeControl with specified position and dimensions.
     * Initializes with default value range (0-100) at 0, and creates scrolling and stroke objects.
     *
    ...
    /**
     * Appends (adds) a value to the current value.
     * The result will be constrained to the min/max range.
     *
    ...
    /**
     * Sets the scrolling velocity (inertia decay rate).
     * Higher values cause scrolling to stop faster.
     *
     ...
     * Useful for detecting degenerate ranges where no selection is possible.
     *
    ...
    /**
     * Sets the value without triggering any change listeners.
     * Useful for programmatic updates that shouldn't fire events.
     *
     ...
     * Provides smooth scrolling with configurable velocity and reverse scrolling options.
     */
    protected final class Scrolling {
        ...
        /**
         * Initializes scrolling based on a mouse wheel event.
         * Accumulates speed based on the wheel direction and count.
         *
        ...
        /**
         * Gets the current scrolling delta and updates scrolling state.
         * Applies velocity-based decay to the scrolling speed.
         *
        ...
        /**
         * Sets the scrolling velocity (decay rate).
         * Higher values cause scrolling to stop faster.
         *
         * @param velocity the scrolling velocity to set
         */
         ...
         *
         * @param reverse true to reverse scrolling direction, false for normal scrolling
         */

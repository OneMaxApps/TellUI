 ...
 * keyboard events from the Processing framework. Provides both a default
...
public interface KeyPressable {
	 ...
	 * <p>
	 * This default implementation does nothing. Override to provide
	 * custom behavior for simple key press events without needing
	 ...
	 * key press events. The KeyEvent provides detailed information
	 * about the key press including key code, modifiers, and timing.
	 * </p>
	 * 

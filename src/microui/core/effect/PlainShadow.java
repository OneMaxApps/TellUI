...
/**
 * A simple shadow effect that creates a solid or gradient outline around a ContentView.
 * Extends AbstractShadow to provide a basic shadow implementation with optional alpha fade-out.
 * <p>
 * The PlainShadow can render either a solid outline or a gradient fade-out effect
...
public class PlainShadow extends AbstractShadow {
	 ...
	 * Alpha fade-out is enabled by default.
	 */
	public PlainShadow() {
		super();
	...
	/**
	 * Renders the plain shadow effect.
	 * Creates either a gradient fade-out or solid outline based on alpha fade-out setting.
	 */
	@Override

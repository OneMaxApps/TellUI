...
/**
 * Abstract base class for all interactive UI components in the microui framework.
 * Component provides comprehensive interaction handling, event management, tooltip support,
 * and visual styling for UI elements.
 * 
...
public abstract class Component extends ContentView {
    ...
    /**
     * Constructs a Component with specified position and dimensions.
     * Initializes with default theme background color and creates event,
     * interaction handler, and tooltip systems.
     *
    ...
    /**
     * Constructs a Component at position (0,0) with zero dimensions.
    ...
    /**
     * Draws the component and processes interactions.
     * This method orchestrates rendering, event detection, interaction handling,
     * and tooltip management. It should be called every frame for active components.
     */
    @Override
    public void draw() {
        if (!isVisible()) {
    ...
    /**
     * Checks if the component is currently being pressed (mouse button down over component).
     *
    ...
    /**
     * Checks if the component is currently being released (mouse button up after press).
     *
    ...
    /**
     * Checks if the mouse has been hovering over the component for an extended period.
     *
    ...
    /**
     * Enables or disables the interaction handler for this component.
     * When disabled, no interaction events will be processed or triggered.
     *
    ...
    /**
     * Sets a text tooltip for this component (convenience method).
     * Creates a TextTooltipContent with the specified text.
     *
     ...
     * @throws ClassCastException if the current tooltip content is not a TextTooltipContent
     */

...
/**
 * A slider component for selecting values within a linear range.
 * The Slider extends LinearRangeControl to provide a draggable interface with
 * a visual progress indicator that fills according to the current value.
 * 
 * <p>The slider supports both horizontal and vertical orientations and provides
 * visual feedback through a progress rectangle that grows/shrinks as the value changes.</p>
 * 
 * <p>Users can click or drag anywhere on the slider track to set the value,
...
public class Slider extends LinearRangeControl {
    ...
    /**
     * Constructs a Slider with specified position and dimensions.
     * The slider is initialized with a progress indicator and default value range.
     *
    ...
    /**
     * Constructs a Slider with default maximum size, centered on the screen.
     * This is a convenience constructor for creating a centered slider.
     */
    public Slider() {
        this(0, 0, 0, 0);

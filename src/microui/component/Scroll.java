...
/**
 * A scrollbar component with a draggable thumb for selecting values within a range.
 * The Scroll extends LinearRangeControl to provide linear scrolling functionality
 * with both horizontal and vertical orientations.
 * 
 * <p>The scrollbar consists of a track and a draggable thumb. The thumb's size
 * is determined by the thumbSizeRatio, which represents the proportion of the
 * track that the thumb occupies.</p>
 * 
 * <p>Users can drag the thumb along the track to change the value, and the thumb
 * provides visual feedback through hover and ripple effects.</p>
 */
public class Scroll extends LinearRangeControl {
    ...
    /**
     * Constructs a Scroll with specified position and dimensions.
     * The scrollbar is initialized with a thumb button, default styling,
     * and a thumb size ratio of 0.1 (10% of the track).
     *
    ...
    /**
     * Constructs a Scroll with default maximum size, centered on the screen.
     * This is a convenience constructor for creating a centered scrollbar.
     */
    public Scroll() {
        this(0, 0, 0, 0);
    ...
    /**
     * Swaps the orientation of the scrollbar (horizontal to vertical or vice versa).
    ...
    /**
     * Gets the calculated size of the thumb based on the thumbSizeRatio and orientation.
     * For horizontal scrollbars, returns width × thumbSizeRatio.
     * For vertical scrollbars, returns height × thumbSizeRatio.
     *
    ...
    /**
     * Sets the ratio that determines the thumb size relative to the track.
     * The thumbSizeRatio must be between 0 and 1 inclusive.
     *
     * @param thumbSizeRatio the ratio of thumb size to track size (0 to 1)
     * @throws IllegalStateException if thumbSizeRatio is less than 0 or greater than 1
     */

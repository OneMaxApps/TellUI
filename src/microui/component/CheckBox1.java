...
import static microui.component.CheckBox1.CheckStyle.MARK;
 ...
 * @see CheckStyle
 */
public class CheckBox1 extends AbstractButton {
	 ...
	 */
	public CheckBox1(float x, float y) {
		super(x, y, 0, 0);
	 ...
	 */
	public CheckBox1(boolean checked) {
		this(0, 0);
		setPositionInCenter();
		setChecked(checked);
	}

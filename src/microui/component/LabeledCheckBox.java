...
/**
 * A composite component that combines a {@link CheckBox} with a {@link TextView}
 * to create a labeled checkbox. The component provides hover effects and
 * allows the entire area (checkbox + label) to be clickable.
 * 
 * <p>The layout uses a {@link RowLayout} with the checkbox taking 10% of the width
 * and the label text taking 90% of the width by default.</p>
 * 
 * @see CheckBox
 * @see TextView
 * @see Container
...
public final class LabeledCheckBox extends Component {
    ...
    /**
     * Constructs a LabeledCheckBox with specified position and dimensions.
     * The component is initialized with default sizing constraints and layout.
     *
    ...
    /**
     * Constructs a LabeledCheckBox with the specified label text.
     * The component is centered on the screen and sized to maximum dimensions.
     *
    ...
    /**
     * Constructs a LabeledCheckBox with an empty label.
     * The component is centered on the screen and sized to maximum dimensions.
     */
    ...
    /**
     * Renders the labeled checkbox.
     * The rendering includes hover effects and the container with its children.
     */
    @Override
     ...
     * Updates the bounds of the internal container to match the component's new bounds.
     */
    @Override

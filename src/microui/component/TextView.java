...
public final class TextView extends Component {
    ...
    /**
     * Constructs a TextView with specified text, position, and dimensions.
     * The text view is initialized with automatic resizing enabled and centered alignment.
     *
    ...
    /**
     * Constructs a TextView with specified position and dimensions but no initial text.
     *
     * @param x the x-coordinate of the text view's top-left corner
     * @param y the y-coordinate of the text view's top-left corner
     * @param width the width of the text view
     ...
     *
     * @return true if text is clipped to component bounds, false if text can overflow
     */
    ...
    /**
     * Enables or disables automatic text resizing.
     * When enabled, text size is automatically calculated to fit within component bounds.
     *
     * @param autoResizeModeEnabled true to enable auto-resize, false to use manual text size
     */
     ...
     * Draws background, then text with configured alignment, sizing, and clipping.
     */
    @Override
    ...
    /**
     * Called when the text view's bounds change.
     * Recalculates auto-text size if auto-resize is enabled.
     */
    @Override

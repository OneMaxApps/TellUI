 ...
 * 
 * <p>Contains static methods for common mathematical operations such as value
 * constraining, range conversion, collision detection, and distance calculation.</p>
 */
public final class MathUtils {
     ...
     * 
     * <p>If the value is less than the minimum, returns the minimum.
     ...
     * 
     * <p>Linearly maps a value from the source range [min, max] to the
     * target range [newMin, newMax].</p>
     * 
     * <p>Example: convert(50, 0, 100, 0, 1) returns 0.5</p>
     * 
     ...
     * 
     * <p>Performs axis-aligned bounding box (AABB) collision detection
     * between two SpatialView objects based on their position and dimensions.</p>
     * 

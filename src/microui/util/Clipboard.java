...
/**
 * Utility class for clipboard operations with support for both system and local
 * buffers.
 * 
 * <p>
 * Provides methods to copy and paste text to/from the clipboard. Supports
 * switching between the operating system's clipboard and a local buffer for
...
public final class Clipboard {
	 ...
	 * 
	 * <p>
	 * Depending on the buffer mode, copies to either the system clipboard or local
	 * buffer.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * Each string in the array becomes a separate line in the clipboard content.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * Depending on the buffer mode, retrieves from either the system clipboard or
	 * local buffer. Returns an empty string if an error occurs while accessing the
	 * system clipboard.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * Splits the clipboard content by newline characters to create an array of
	 * strings.
	 * </p>
	 * 
	 ...
	 * 
	 * <p>
	 * All subsequent clipboard operations will use an in-memory local buffer
	 ...
	 * 
	 * <p>
	 * All subsequent clipboard operations will use the operating system's
	 * clipboard.
	 * </p>
	 */

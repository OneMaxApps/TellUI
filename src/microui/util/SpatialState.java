 ...
 * 
 * <p>Contains position (x, y) and dimensions (width, height) information.
 * Useful for capturing and comparing spatial states at different points in time,
 * or for passing spatial data without exposing mutable objects.</p>
 * 
...
public record SpatialState(float x, float y, float width, float height) {
     ...
     * 
     * <p>Extracts the spatial properties (position and dimensions) from the
     * provided SpatialView object.</p>
     * 
     ...
     * 
     * <p>Creates a new SpatialState with the same values as the provided source.</p>
     * 

 ...
 * 
 * <p>
 * Looping can be temporarily disabled while keeping the current progress state,
...
public class LerpedLoopColor extends AbstractLerpedColor {
	 ...
	 * 
	 * @return true if the color is automatically cycling between start and end
	 *         colors, false if the animation is paused at its current progress
	 */
	...
	/**
	 * Updates the animation state before applying color operations. When loop mode
	 * is enabled, this method triggers an animation update to progress the
	 * interpolation. When loop mode is disabled, the animation remains at its
	 * current progress.
	 * 
	 * <p>

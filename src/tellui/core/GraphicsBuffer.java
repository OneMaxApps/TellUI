...
/**
 * A container for managing off-screen graphics buffers with composable buffered
 * views. GraphicsBuffer provides a flexible way to render multiple BufferedView
 * components to an off-screen PGraphics buffer before compositing them onto the
...
public class GraphicsBuffer extends SpatialView {
	...
	/**
	 * Constructs a GraphicsBuffer with specified position and dimensions. Creates
	 * an initial graphics buffer and sets up default properties.
	 *
	...
	/**
	 * Constructs a GraphicsBuffer at position (0,0) with zero dimensions. Useful
	 * when bounds will be set later.
	 */
	...
	/**
	 * Enables or disables automatic clearing of the buffer before each render
	 * cycle. When enabled, the buffer is cleared to transparency before rendering.
	 *
	...
	/**
	 * Gets the underlying PGraphics buffer. Useful for direct manipulation of the
	 * graphics context.
	 *
	...
	/**
	 * Adds a BufferedView to be rendered to this graphics buffer. BufferedViews are
	 * drawn in the order they are added.
	 *

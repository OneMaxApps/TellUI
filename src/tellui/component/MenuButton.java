...
import tellui.core.effect.ReactiveShadow;
...
import tellui.core.interfaces.ModalParent;
 ...
 * functionality with support for nested menus, icons, scrollable items, and
 * directional placement.
 * 
 * <p>
 * <strong>Note:</strong> If a menu is the root menu, it displays as a vertical
 * list. Non-root menus add horizontal shifting to create nested menu
 * hierarchies.
 * </p>
 * 
 * @see Button
...
public final class MenuButton extends Button implements Scrollable, ModalParent {
	...
	/**
	 * Constructs a MenuButton with specified text, position, and dimensions. The
	 * menu is initialized with default styling and item dimensions.
	 *
	...
	/**
	 * Handles mouse wheel scrolling for the menu hierarchy. If this is the root
	 * menu and there's an active sub-menu, delegates to it. Otherwise, scrolls the
	 * items of this menu.
	 *
	...
	/**
	 * Finds a button by its title, optionally searching recursively through
	 * sub-menus.
	 *
	 * @param title     the title to search for
	 * @param recursive true to search in sub-menus, false to search only in this
	 *                  menu
	...
	/**
	 * Gets a button by its title, searching recursively. Throws an exception if not
	 * found.
	 *
	 * @param title the title to search for
	...
	/**
	 * Gets a button by its title, optionally searching recursively. Throws an
	...
	/**
	 * Gets a menu button by its title, searching recursively. Throws an exception
	 * if not found or not a menu.
	 *
	 * @param title the title to search for
	...
	/**
	 * Gets a menu button by its title, optionally searching recursively. Throws an
	 * exception if not found or not a menu.
	 *
	 * @param title     the title to search for
	 * @param recursive true to search in sub-menus, false to search only in this
	 *                  menu
	...
	/**
	 * Gets a button by its ID, searching recursively. Throws an exception if not
	 * found.
	 *
	 * @param id the ID to search for
	 * @return the found button
	...
	/**
	 * Gets a button by its ID, optionally searching recursively. Throws an
	 * exception if not found.
	 *
	 * @param id        the ID to search for
	 * @param recursive true to search in sub-menus, false to search only in this
	...
	/**
	 * Gets a menu button by its ID, searching recursively. Throws an exception if
	 * not found or not a menu.
	 *
	 * @param id the ID to search for
	 * @return the found menu button
	 * @throws NoSuchElementException if no button with the specified ID exists
	...
	/**
	 * Gets a menu button by its ID, optionally searching recursively. Throws an
	 * exception if not found or not a menu.
	 *
	 * @param id        the ID to search for
	 * @param recursive true to search in sub-menus, false to search only in this
	...
	/**
	 * Gets a button by its text ID, searching recursively. Throws an exception if
	 * not found.
	 *
	 * @param textId the text ID to search for
	 * @return the found button
	...
	/**
	 * Gets a button by its text ID, optionally searching recursively. Throws an
	 * exception if not found.
	 *
	 * @param textId    the text ID to search for
	 * @param recursive true to search in sub-menus, false to search only in this
	...
	/**
	 * Gets a menu button by its text ID, searching recursively. Throws an exception
	 * if not found or not a menu.
	 *
	 * @param textId the text ID to search for
	 * @return the found menu button
	...
	/**
	 * Gets a menu button by its text ID, optionally searching recursively. Throws
	 * an exception if not found or not a menu.
	 *
	 * @param textId    the text ID to search for
	 * @param recursive true to search in sub-menus, false to search only in this
	 *                  menu
	 ...
	 * @param recursive true to apply to items in sub-menus, false for only this
	 *                  menu
	 * @return this MenuButton instance for method chaining
	 */
